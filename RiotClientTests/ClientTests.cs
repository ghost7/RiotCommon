...
namespace RiotClientTests
{
    ...
    public class ClientTests
    {
        ...
        public async Task TestSummonerClient_ByMultipleNames()
        {
            ...
            var expectedUriString = $"{Region}/v{version}/summoner/by-name/{string.Join(",", summonerName, summonerName2)}";
        ...
        public async Task TestSummonerClient_ByMultipleIds()
        {
            ...
            var expectedUriString = $"{Region}/v{version}/summoner/{string.Join(",", summonerId, summonerId2)}";
        ...
        public async Task TestSummonerClient_MultipleSummonerMasteries()
        {
            ...
            var summonerId = "20132258";
            var summonerId2 = "51405";
            var expectedUriString = $"{Region}/v{version}/summoner/{string.Join(",", summonerId, summonerId2)}/masteries";
        ...
        public async Task TestSummonerClient_MultipleSummonerRunes()
        {
            ...
            var summonerId = "20132258";
            var summonerId2 = "51405";
            var expectedUriString = $"{Region}/v{version}/summoner/{string.Join(",", summonerId, summonerId2)}/runes";
