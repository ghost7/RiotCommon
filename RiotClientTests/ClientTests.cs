...
namespace RiotClientTests
{
    ...
    public class ClientTests
    {
        ...
        public async Task TestSummonerClient_ByName()
        {
            ...
            using (var summonerClient = new SummonerClient(Region, version, this.apiKey))
            {
        ...
        {
            var version = "1.2";
            using (var staticDataClient = new StaticDataClient(Region, version, this.apiKey))
            {
        ...
        public async Task TestMatchListClient()
        {
            var version = "2.2";
            var summonerId = "20132258";
            using (var client = new MatchListClient(Region, version, this.apiKey))
            {
